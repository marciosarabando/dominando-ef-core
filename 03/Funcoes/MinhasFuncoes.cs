...
namespace DominandoEntityFramework.Funcoes
{
    public static class MinhasFuncoes
    {
        ...
        public static string LetrasMaiusculas(string dados) => throw new NotImplementedException();

        public static int DateDiff(string identificador, DateTime dataInicial, DateTime dataFinal) => throw new NotImplementedException();
